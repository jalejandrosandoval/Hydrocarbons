 ...
 *   https://datatables.net/download/#bs4/dt-1.10.20/af-2.3.4/b-1.6.1/b-colvis-1.6.1/b-flash-1.6.1/b-html5-1.6.1/cr-1.5.2/fc-3.3.0/fh-3.1.6/kt-2.5.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sp-1.0.1/sl-1.3.1
 *
 * Included libraries:
 *   DataTables 1.10.20, AutoFill 2.3.4, Buttons 1.6.1, Column visibility 1.6.1, Flash export 1.6.1, HTML5 export 1.6.1, ColReorder 1.5.2, FixedColumns 3.3.0, FixedHeader 3.1.6, KeyTable 2.5.1, Responsive 2.2.3, RowGroup 1.1.1, RowReorder 1.2.6, Scroller 2.0.1, SearchPanes 1.0.1, Select 1.3.1
 */
...
sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay datos disponibles en la base de Datos del Sistema...",sInfo:"Mostranto _START_ - _END_ de un Total de _TOTAL_ registros",sInfoEmpty:"Mostrado 0 - 0 de un Total de 0 registros", sInfoFiltered:"(Filtarados de un Total de _MAX_ Registros)", sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ Registros",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"Buscar...",sUrl:"",sZeroRecords:"No se encontraron Resultados..."},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
